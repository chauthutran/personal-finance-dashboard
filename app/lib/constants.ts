...
export const FETCH_TRANSATION_lIST_REQUEST = "FETCH_TRANSATION_lIST_REQUEST";
export const FETCH_TRANSATION_lIST_SUCCESS = "FETCH_TRANSATION_lIST_SUCCESS";
export const FETCH_TRANSATION_lIST_FAILURE = "FETCH_TRANSATION_lIST_FAILURE";
