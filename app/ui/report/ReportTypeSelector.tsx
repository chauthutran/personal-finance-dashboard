...
const reportTypes = [
	Constant.REPORT_TYPE_INCOME_VS_REPORT, // Compare income and expenses over a period ( Bar Chart and Line Chart) 
	'Budget vs. Actual Report', // Compare budgeted amounts with actual spending ( Bar Chart and Line Chart) 
